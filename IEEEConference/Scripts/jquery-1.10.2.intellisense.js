...
intellisense.annotate(jQuery, {
  ...
  'param': function() {
    /// <signature>
    ///   <summary>Create a serialized reStyle of an array or object, suitable for use in a URL query string or Ajax request.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'outerHeight': function() {
    /// <signature>
    ///   <summary>Get the current computed height for the first element in the set of matched elements, including padding, border, and optionally margin. Returns an integer (without "px") reStyle of the value or null if called on an empty set of elements.</summary>
